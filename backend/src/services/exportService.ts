...
export class ExportService {
  ...
  public static generateSignalPdf(
    ...
    return new Promise((resolve, reject) => {
      ...
      doc.fontSize(8);
      expertInterpretation.causality.reasoning.forEach((reason: string) => {
        doc.text(`  ${reason}`);
      });
      ...
      doc.font('Helvetica')
         .fontSize(8.5);
      expertInterpretation.capaRecommendations.forEach((capa: string, idx: number) => {
